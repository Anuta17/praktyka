    ...
    palettes.forEach(palette => {
        ...
        paletteCard.innerHTML = `
            ...
            <div class="palette-info">
                <span class="emoji">${palette.emoji}</span>
                <span class="palette-name">${palette.paletteName}</span>
            </div>
        `;
        paletteCard.addEventListener('click', () => openModal(palette));
...
function openModal(palette) {
    ...
    const modalPaletteName = document.getElementById('modalPaletteName');
    const modalPalette = document.getElementById('modalPalette');
    const closeModal = document.getElementById('closeModal');

    modalPaletteName.textContent = palette.paletteName;
    modalPalette.innerHTML = palette.colors.map(color => `
        <div class="modal-color" style="background: ${color.color}" data-color="${color.color}"></div>
    `).join('');

    modalPalette.addEventListener('click', handleColorClick);
